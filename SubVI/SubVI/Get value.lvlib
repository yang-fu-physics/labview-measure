...
<Library LVVersion="19008000">
	...
	<Item Name="335 Read and Compressor auto control(SubVI).vi" Type="VI" URL="../335 Read and Compressor auto control(SubVI).vi"/>
	...
	<Item Name="Get Rotate Temp(SubVI).vi" Type="VI" URL="../Get Rotate Temp(SubVI).vi"/>
	<Item Name="Read 2400 Data (SubVI).vi" Type="VI" URL="../Read 2400 Data (SubVI).vi"/>
</Library>
